...
def get_args():
    ...
    parser.add_argument("--dataset_local_pathname", type=str)
...
def create_datasets(tokenizer, args):
    dataset = load_dataset(
        ...
        data_files=args.dataset_local_pathname,
        split=args.split,
        use_auth_token=True,
...
def run_training(args, train_data, val_data):
    ...
    lora_config = LoraConfig(
        ...
        bias="none",
        task_type="CAUSAL_LM",
#        target_modules = ["c_proj", "c_attn", "q_attn"]     # This is the original setting
        target_modules = ["c_proj", "c_attn", "q_attn", "c_fc", "lm_head"]
    )
